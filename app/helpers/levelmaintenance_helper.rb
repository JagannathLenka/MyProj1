  ...
  def level_jqgrid
    ...
    grid = [{
      ...
      :colModel  => [
        ...
        { :name => 'cl_bay_id',   :index => 'cl_bay_id',    :width => 100,   :align => 'center', :editable => false },
        ...
        { :name => 'cl_aisle_id',   :index => 'cl_aisle_id',    :width => 100,   :align => 'center', :editable => false, :hidden => false},
        { :name => 'sm_zone_id',   :index => 'sm_zone_id',    :width => 120,   :align => 'center', :editable => false, :hidden => true},
        { :name => 'cl_zone_id',   :index => 'cl_zone_id',    :width => 100,   :align => 'center', :editable => false, :hidden => false},
