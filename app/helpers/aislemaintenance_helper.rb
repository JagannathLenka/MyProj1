module AislemaintenanceHelper
  ...
  def aisle_jqgrid
    ...
    url = "/aislemaintenance?id=" +  params["id"]
      ...
      :datatype => 'json',
      :mtype => 'GET',
      :colNames => ['Id','Sequence', 'Aisle id(cust)','Client Id','sm_zone_id', 'Zone','zone_id','sm_warehouse_id','Warehouse','Description','Bays/Aisle','Types of Aisle','Attribute2','Attribute3','Attribute4','Attribute5','Attribute6','Attribute7','Attribute8'],
      :colModel  => [
        ...
        { :name => 'cl_aisle_id', :index => 'cl_aisle_id',  :width => 60, :align => 'center', :editable => true},
        { :name => 'client_id', :index => 'client_id',  :width => 50, :align => 'center', :editable => false, :hidden => false},
        ...
        { :name => 'no_of_bays_aisle',:index => 'no_of_bays_aisle',     :width => 150,  :align => 'left', :editable => true },
