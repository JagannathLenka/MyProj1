module AislemaintenanceHelper
  ...
  def aisle_jqgrid
    ...
    url = "/aislemaintenance?id=" +  params["id"]
      ...
      :datatype => 'json',
      :mtype => 'GET',
      :colNames => ['Id','Sequence', 'Aisle id(cust)','Client Id','sm_zone_id', 'Zone','zone_id','sm_warehouse_id','Warehouse','Description','Bays/Aisle','Attribute1','Attribute2','Attribute3','Attribute4','Attribute5','Attribute6','Attribute7','Attribute8'],
      :colModel  => [
        ...
        { :name => 'cl_aisle_id', :index => 'cl_aisle_id',  :width => 80, :align => 'center', :editable => true},
        ...
        { :name => 'description',   :index => 'description',   :width => 190,   :align => 'center', :editable => true},
