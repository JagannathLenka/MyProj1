module AislemaintenanceHelper
  ...
  def aisle_jqgrid
    ...
    url = "/aislemaintenance?id=" +  params["id"]
      ...
      :datatype => 'json',
      :mtype => 'GET',
      :colNames => ['Id','Sequence', 'Aisle','Client Id','sm_zone_id', 'Zone','zone_id','sm_warehouse_id','Warehouse','Description','Bays/Aisle','no_of_bays_aisle_hidden','Attribute1','Attribute2','Types of Aisle','Attribute4','Attribute5','Attribute6','Attribute7','Attribute8'],
      :colModel  => [
