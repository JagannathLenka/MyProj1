  ...
  def loc_jqgrid
    ...
    selectrowfunc = "function(id) { 
      ...
      :colNames => ['Id','Sequence','Location','sm_pos_id', 'Position', 'sm_level_id','Level','sm_bay_id', 'Bay',
                    ...
                    'Current Item','Current Quantity','Lifetime TotalPicks','Lock Code', 'Maximum Quantity','Minimum Quantity','Status','Priority Location',
      ...
      :colModel  => [
        ...
        { :name => 'cl_barcode',   :index => 'cl_barcode',   :width => 160,   :align => 'center', :editable => true},
        ...
        {:name => 'lock_code', :index => 'lock_code',  :width => 80, :align => 'center', :editable => true},
        ...
        {:name => 'location_priority', :index => 'location_priority',  :width => 120, :align => 'center', :editable => true},
