  ...
  def loc_jqgrid
    ...
    selectrowfunc = "function(id) { 
      ...
      :colModel  => [
        ...
        { :name => 'location[cl_warehouse_id]', :index => 'cl_warehouse_id',   :width => 100,   :align => 'center', :editable => true, :hidden => false},
        ...
        {:name => 'location[location_length]', :index => 'location_length',  :width => 120, :align => 'center', :editable => true, :hidden => true},
        {:name => 'location[location_breadth]', :index => 'location_breadth',  :width => 120, :align => 'center', :editable => true, :hidden => true},
        {:name => 'location[location_height]', :index => 'location_height',  :width => 120, :align => 'center', :editable => true, :hidden => true},
        {:name => 'location[location_volume]', :index => 'location_volume',  :width => 120, :align => 'center', :editable => true, :hidden => true},
        {:name => 'location[allowed_weight]', :index => 'allowed_weight',  :width => 120, :align => 'center', :editable => true, :hidden => true},
