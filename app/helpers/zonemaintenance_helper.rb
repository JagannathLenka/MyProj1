module ZonemaintenanceHelper
  ...
  def zone_jqgrid
    ...
    grid = [{
      ...
      :datatype => 'json',
      :mtype => 'GET',
      :colNames => ['Id','Zone Id','Zone Id(Cust)','Description', 'Aisles/Zone', 'Bays/Aisle','Level/Aisle','Warehouse', 'Properties1', 'Properties2', 'Properties3'], 
      :colModel  => [
        { :name => 'id',   :index => 'id',    :width => 50, :align => 'center',hidden:true},
        { :name => 'zone_id',   :index => 'zone_id',    :width => 85, :align => 'center',formatter:'showlink', formatoptions:{baseLinkUrl:'/aislemaintenance'}, :editable => false},
