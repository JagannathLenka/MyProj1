  ...
  def bays_jqgrid
    ...
    grid = [{
      ...
      :colModel  => [
        ...
        {:name => 'cl_bay_id', :index => 'cl_bay_id',  :width => 120, :align => 'center', :editable => true, editrules:{required:true},formatter:'showlink', formatoptions:{baseLinkUrl:'/levelmaintenance'}},
        ...
        { :name => 'attribute3',   :index => 'attribute3',   :width => 120,   :align => 'center', :editable => false ,editrules:{required:true}},
