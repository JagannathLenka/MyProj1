MyProj1::Application.routes.draw do
  resources :warehouse, :bay, :position, :login, :usermaintenance, :posmaintenance, :levelmaintenance, :baysmaintenance, :aislemaintenance, :zonemaintenance, :warehousemaintenance 
